...
describe('Location Routes', () => {
  ...
  describe('list', () => {
    ...
    test('supports cursor pagination', async () => {
      ...
      const second = await call(locationRoutes.list, { limit: 2, cursor: first.nextCursor! }, { context: ctx })
  ...
  describe('remove', () => {
    ...
    test('throws NOT_FOUND for non-existent location', async () => {
      ...
      await expect(
        call(locationRoutes.remove, { id: '00000000-0000-0000-0000-000000000000' }, { context: ctx })
      ).rejects.toMatchObject({
        code: 'NOT_FOUND',
      })
    })
