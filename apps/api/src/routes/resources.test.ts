...
describe('Resource Routes', () => {
  ...
  describe('list', () => {
    ...
    test('supports cursor pagination', async () => {
      ...
      const second = await call(resourceRoutes.list, { limit: 2, cursor: first.nextCursor! }, { context: ctx })
    ...
    test('filters by locationId', async () => {
      ...
      const result = await call(resourceRoutes.list, { limit: 10, locationId: location.id }, { context: ctx })
  ...
  describe('remove', () => {
    ...
    test('throws NOT_FOUND for non-existent resource', async () => {
      ...
      await expect(
        call(resourceRoutes.remove, { id: '00000000-0000-0000-0000-000000000000' }, { context: ctx })
      ).rejects.toMatchObject({
        code: 'NOT_FOUND',
      })
    })
